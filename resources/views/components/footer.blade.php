<footer class="w-full bg-cyan-900 h-auto xl:h-80 text-xl relative">
  <div class="md:container px-5  md:px-0 mx-auto grid grid-rows md:grid-cols-3 pt-5">
    ...
    <div class="text-start pb-5 md:pb-0 text-white">
      ...
      <div class="block w-full uppercase">
        <ul>
          <li class="pb-2"><i class="fa-solid fa-house-chimney mr-3 w-8"></i><a href='{{ route('home') }}'>home</a></li>
          <li class="pb-2"><i class="fa-solid fa-warehouse mr-3 w-8"></i><a href='{{ route('inventory') }}'>inventory</a></li>
          <li class="pb-2"><i class="fa-solid fa-hand-holding-dollar mr-3 w-8"></i><a href='{{ route('finance') }}'>financing</a></li>
          <li class="pb-2"><i class="fa-solid fa-at mr-3 w-8"></i><a href='{{ route('contact') }}'>contact</a></li>
        </ul>
      </div>
    </div>
