  ...
  <section class="py-10">
    <div class="md:container md:mx-auto p-4">
      ...
      <p class="py-5 text-lg mb-10">
        There are many benefits to getting your equipment financed instead of paying for it all at once upfront. The most important benefit is that you don’t have to come up with a large lump sum payment right away which means that you can save up money beforehand and then make payments on the loan as they come due while still having enough money left over to cover other expenses like marketing or payroll. This can be especially useful if your business isn’t doing well because then you
      </p>
      <div class="flex-rows md:flex justify-center items-center gap-5 bg-neutral-50 shadow rounded-xl ring-2 ring-cyan-700 relative">
        
        <img src="{{ asset('img/equipment-capital-corp.jpg') }}" alt="Used equipment Financing provided by Equipment Capital Corp - Alberta Crane Service" class="w-full pb-5 lg:pb-0 lg:float-left lg:w-1/2 p-2 rounded-xl shadow">
        <div class="px-5 lg:px-0">
          <h3 class="uppercase text-cyan-800 font-medium pb-5 lg:pb-0 text-2xl lg:text-3xl lg:absolute lg:top-0 lg:left-2/6 lg:-translate-x-2/6">Equipment Capital Corp.</h3>
